  ...
  header("Location: index.php");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
        ...
        if ($action === 'accept') {
            ...
            $update_query = "UPDATE leaves SET status='Accepted', remarks='$remarks' WHERE eid=$eid";
        } elseif ($action === 'reject') {
            // Update leave status to Rejected for the specific application
            $update_query = "UPDATE leaves SET status='Rejected', remarks='$remarks' WHERE eid=$eid";
        }
...
<body>
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="leaveAplicationForm.php">KABU STUDENT LEAVE APPLICATION </a>
      <ul class="nav justify-content-end">
           
            <li class="nav-item">
                <a class="nav-link" href="myhistory.php" style="color:white;"><b>Leave History</b></a>
            </li>
            <li class="nav-item">
