...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="admin.php">KABU STUDENT ONLINE LEAVE APPLICATION </a>
    ...
    <h1>KABU ADMINISTRATOR - Registered Students</h1>
                          ...
                          if($leaves){
                            ...
                            if($numrow!=0){
                             ...
                             $cnt++; }
                              ...
                              echo"<tr class='text-center'><td colspan='12'><b>YOU DON'T HAVE ANY REGISTERED STUDENT!</b></td></tr>";
                            }
                          }
                          else{
